...
struct MenuGenerate1: View {
    // Used to show or hide drop-down menu options
    @State private var isOptionsPresented: Bool = false
    // Used to bind user selection
    @Binding var selectedOption: MenuOptionGenerate1?
    
    let placholder: String
    let options: [MenuOptionGenerate1]
...
struct MenuGenerate1_Previews: PreviewProvider {
    static var previews: some View {
        MenuGenerate1(selectedOption: .constant(nil), placholder: "Select Your project", options: MenuOptionGenerate1.testAllMenu)
