...
struct DropdownMenu: View {
        ...
        @Binding var selectedOption: MenuOptionRefine?
        
        let placholder: String
        let options: [MenuOptionRefine]
...
struct DropdownMenu_Previews: PreviewProvider {
    static var previews: some View {
        DropdownMenu(selectedOption: .constant(nil), placholder: "Select Your project", options: MenuOptionRefine.testAllMenu)
